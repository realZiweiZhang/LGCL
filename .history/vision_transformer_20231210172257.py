...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x, task_id=-1, cls_features=None, train=False, task_level_text=None, class_level_text=None):
...
def text_supervised_loss(key, text_feature):
