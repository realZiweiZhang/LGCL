        ...
        with torch.no_grad():
            if original_model is not None:
                ...
                if class_names:
                    ...
                    num_class_learn = len(class_names)
                    
                    task_level_info = [' or'+ str(x) if ]
                    task_level_text = clip.tokenize(f"a photo of {a} or {b} or {c} or {d} or {e} or {f} or {g} or")
