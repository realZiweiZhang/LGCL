...
def train_one_epoch(model: torch.nn.Module, original_model: torch.nn.Module, coop_model: torch.nn.Module,
    ...
    for task_id in range(args.num_tasks):
       # Transfer previous learned prompt params to the new prompt
        ...
        for epoch in range(args.epochs):            
            train_stats = train_one_epoch(model=model, original_model=original_model, clip_model=clcriterion=criterion, 
