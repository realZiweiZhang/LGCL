...
def main(args):
    ...
    data_loader, class_mask, class_names = build_continual_dataloader(args)
    ...
    train_and_evaluate(model, model_without_ddp, original_model, clip_model,
                    criterion, data_loader, optimizer, lr_scheduler,
                    device, class_mask, class_names, args)
