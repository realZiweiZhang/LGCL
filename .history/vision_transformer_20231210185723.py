...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, task_id=-1, cls_features=None, train=False,
                task_level_pos_text=None,tastk_level_neg_text=None,
        ...
        res = self.forward_features(x, task_id=task_id, cls_features=cls_features, train=train,
                                    task_level_pos_text=task_level_pos_text,task_level_pos_text=text_level_neg_text,)
        res = self.forward_head(res,class_level_pos_text,class_level_neg_text)
        return res
